---
name: do-issue
description: Claim and execute an unassigned dependency chain from a GitHub issue's progress table — propose a plan, wait for approval, then one PR per task.
